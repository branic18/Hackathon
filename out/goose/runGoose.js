 ...
 */
function runGooseForVuln(context) {
 ...
 */
function runGooseWithRetry(context_1) {
    return __awaiter(this, arguments, void 0, function* (context, maxRetries = 2) {
        let lastError;
        for (let attempt = 0; attempt <= maxRetries; attempt++) {
            try {
                return yield runGooseForVuln(context);
            }
            catch (error) {
